    ...
    <div id="content">
            ...
            <div class="history-slider">
                ...
                <div class="history-slides">
                    <div>
                        <div class="row">
                            <div class="col-sm-5">
                                <img src="/source/images/about/hinh-happy-birthday-cuc-xinh.jpg" alt="">
                            </div>
                            <div class="col-sm-7">
                    ...
                    <div>
                        <div class="row">
                            <div class="col-sm-5">
                                <img src="/source/images/about/web-design.jpg" alt="">
                            </div>
                            <div class="col-sm-7">
                    ...
                    <div>
                        <div class="row">
                            <div class="col-sm-5">
                                <img src="/source/images/about/WebDevelopmentImage.webp" alt="">
                            </div>
                            <div class="col-sm-7">
                    ...
                    <div>
                        <div class="row">
                            <div class="col-sm-5">
                                <img src="/source/images/about/photoshop.jpg" alt="">
                            </div>
                            <div class="col-sm-7">
                    ...
                    <div>
                        <div class="row">
                            <div class="col-sm-5">
                                <img src="/source/images/about/skill.jpg" alt="">
                            </div>
                            <div class="col-sm-7">
                    ...
                    <div>
                        <div class="row">
                            <div class="col-sm-5">
                                <img src="/source/images/about/project.jpg" alt="">
                            </div>
                            <div class="col-sm-7">
                    ...
                    <div>
                        <div class="row">
                            <div class="col-sm-5">
                                <img src="/source/images/about/coffe.jpg" alt="">
                            </div>
                            <div class="col-sm-7">
        ...
        <div class="row">
            <div class="col-sm-6 wow fadeInLeft">
                <div class="beta-person media">
                    ...
                    <img class="pull-left" src="/source/images/about/person2.webp" alt="">
            ...
            <div class="col-sm-6 wow fadeInRight">
                <div class="beta-person media ">
                    ...
                    <img class="pull-left" src="/source/images/about/person3.jpg" alt="">
        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="beta-person beta-person-full">
                    <div class="bets-img-hover">
                        <img src="/source/images/about/person1.jpg" alt="">
                    </div>
            ...
            <div class="col-sm-3">
                <div class="beta-person beta-person-full">
                    <div class="bets-img-hover">
                        <img src="/source/images/about/person2.webp" alt="">
                    </div>
                    <div class="beta-person-body">
                        <h5>Bob Robertson</h5>
                        <p class="font-large">Web developer</p>
            ...
            <div class="col-sm-3">
                <div class="beta-person beta-person-full">
                    <div class="bets-img-hover">
                        <img src="/source/images/about/person3.jpg" alt="">
                    </div>
                    <div class="beta-person-body">
                        <h5>Mike Greenwood</h5>
                        <p class="font-large">Web developer</p>
            ...
            <div class="col-sm-3">
                <div class="beta-person beta-person-full">
                    <div class="bets-img-hover">
                        <img src="/source/images/about/person4.jpeg" alt="">
                    </div>
                    <div class="beta-person-body">
                        <h5>David Black</h5>
                        <p class="font-large">Web developer</p>
