          ...
          <div class="col-sm-8">
            ...
            <div class="single-item-options">
              ...
              {{-- <a class="add-to-cart" href="{{route('themgiohang',$sanpham->id)}}"><i
                  ...
                  <a class="add-to-cart" href="hhh"><i
                    class="fa fa-shopping-cart"></i></a>
              <div class="clearfix"></div>
            </div>
          </div>
            ...
            <div class="col-sm-4">
              <div class="single-item">
                <div class="single-item-header">
                  <a href="detail/{{$sp->id}}"><img src="/source/images/product/{{$sp->image}}" alt=""></a>
                </div>
                ...
                <div class="single-item-caption">
                  {{-- <a class="add-to-cart pull-left" href="{{route('themgiohang',$sp->id)}}"><i
                      class="fa fa-shopping-cart"></i></a> --}}
                      <a class="add-to-cart pull-left" href="hhh"><i
                        class="fa fa-shopping-cart"></i></a>
          ...
          <div class="widget-body">
            <div class="beta-sales beta-lists">
              ...
              <div class="media beta-sales-item">
                <a class="pull-left" href="detail/{{$best->id}}"><img src="/source/images/product/{{$best->image}}"
                    alt=""></a>
                <div class="media-body">
                  
                  <div>{{$best->name}}</div>
                  <span class="beta-sales-price">{{number_format($best->unit_price)}} đồng</span>
                </div>
              </div>
        ...
        <div class="widget">
          ...
          <div class="widget-body">
            <div class="beta-sales beta-lists">
              ...
              <div class="media beta-sales-item">
                <a class="pull-left" href="detail/{{$new->id}}"><img src="/source/images/product/{{$new->image}}"
                    alt=""></a>
                <div class="media-body">
                  <div>{{$new->name}}</div>
                  <span class="beta-sales-price">{{number_format($new->unit_price)}} đồng</span>
                </div>
              </div>
              @endforeach
